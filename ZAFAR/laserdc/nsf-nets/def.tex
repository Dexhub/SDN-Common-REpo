...
\newcommand{\tightcaption}[1]{\vspace{-8pt}\caption{{\bf #1}\vspace{-8pt}}}
\newcommand{\taskref}[1]{\ref{#1}}
\newcommand{\Eqref}[1]{Eq~\eqref{#1}}

\newcounter{tasknmbr}
\newcounter{tasklabel}
\renewcommand{\thetasklabel}{\textbf{Task \thetasknmbr}}
\newenvironment{task}{
\begin{list}{\thetasklabel:}{\usecounter{tasklabel}\stepcounter{tasknmbr}\item\em}}{\end{list}}
...
\newcommand{\ToRs}{ToRs\xspace}
\newcommand{\ArchName}{FireFly\xspace}
\newcommand{\ArchNameExpand}{Free-space optical Inter-Rack nEtwork with high FLexibilitY\xspace}
